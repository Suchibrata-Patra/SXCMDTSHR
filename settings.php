    ...
    <main class="settings-content">
        ...
        <form id="appleSettingsForm" method="post" action="save_settings.php">
            ...
            <div class="section-card">
                ...
                <div class="setting-row">
                    <div class="setting-info">
                        <span class="setting-title">Read Receipts<span style="font-size:0.4rem;color:red;">Currently Under Development</span></span>
            ...
            <h2 id="imap"><span style="background-color:rgb(233, 200, 214);padding:5px;border-radius:5px;">Mail Server Configuration</span></h2>
            <div class="section-card">
                <?php
