...
<div class="sidebar" id="mainSidebar">
    ...
    <div class="sidebar-header">
        <a href="index.php" class="logo">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSL_QbGVO3tHHdoVIJLeFTDoyK2M9mlRxQ1XA&s"
                alt="SXC Logo"
                class="logo-image">
            <div class="logo-text">
    ...
    <nav class="nav-section">
        ...
        <a href="inbox.php" class="nav-item <?= ($current_page == 'inbox') ? 'active' : ''; ?>">
         ...
         <a href="drive_upload.php" class="nav-item <?= ($current_page == 'drive_upload') ? 'active' : ''; ?>">
