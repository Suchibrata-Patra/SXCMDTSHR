...
<body>
    <div class="container">
        ...
        <div class="grid">
            ...
            <div class="test-card">
                ...
                <button class="btn" onclick="runTestSendSingle('test2')">
            ...
            <div class="test-card">
                ...
                <p>Shows recent activity from the bulk mail system logs.</p>
                <button class="btn" onclick="runTest('view_logs', 'test4')">
                    <span>View Logs</span>
                </button>
    ...
    <script>
        ...
        async function runTestSendSingle(testId) {
            ...
            try {
                const response = await fetch(`process_bulk_mail.php?action=test_send_single&email=${encodeURIComponent(email)}`, {
                    method: 'POST'
                });
